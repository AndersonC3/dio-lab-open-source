...
4. Crie uma nova **branch** e nomeie como `feat/community/AndersonC3`: `git checkout -b feat/community/AndersonC3`;
    > Exemplo: `git checkout -b feat/community/AndersonC3`
...
4. Create a new **branch** and name it as `feat/community/AndersonC3`: `git checkout -b feat/community/AndersonC3`;
    > Example: `git checkout -b feat/community/AndersonC3`
